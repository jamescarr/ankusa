defmodule Ankusa.Route do
  @moduledoc """
  The resolved identity of an ingest request: which tenant and source a catch
  URL maps to. Produced by a `Ankusa.RouteResolver` from the raw `Plug.Conn`, so
  ...
  routing) is a pluggable concern the rest of the framework never sees.
    ...
    * `source_id` — the key a `Ankusa.SourceStore` resolves to a `%Ankusa.Source{}`.
