defmodule Hook.Envelope do
  ...
  @type t :: %__MODULE__{
          ...
          verification: Hook.Verification.t() | nil,
...
defmodule Hook.Verification do
  @moduledoc "Result of running a `Hook.Verifier` against an envelope."
