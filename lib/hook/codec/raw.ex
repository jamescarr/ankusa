defmodule Hook.Codec.Raw do
  @moduledoc """
  Default `Hook.Codec`: length-prefixed, CRC-checked framing with no
  compression.
  ...
  exactly the byte range `Hook.BlobStore.get_range/4` must fetch for
  `decode_record/1`.
  """

  @behaviour Hook.Codec
