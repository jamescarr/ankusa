defmodule Hook.BlobStore.GCS do
  @moduledoc """
  `Hook.BlobStore` backed by Google Cloud Storage's JSON API, via `:httpc` —
  ...
  ## Local dev
      ...
      config :hook,
        storage: %{
          blob_store:
            {Hook.BlobStore.GCS, bucket: "hook-segments-dev", endpoint: "http://localhost:4588"}
        }
