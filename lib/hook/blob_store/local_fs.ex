defmodule Hook.BlobStore.LocalFS do
  @moduledoc """
  Default `Hook.BlobStore`: immutable segments on the local filesystem.
  ...
  defp root(instance), do: Config.path(Hook.config(instance), "segments")
end
