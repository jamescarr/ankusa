defmodule Hook.Dispatch.Pipeline do
  @moduledoc """
  ...
  alias Hook.{SourceStore, Telemetry, WAL}
  alias Hook.Dispatch.DLQ

  # ── public API ────────────────────────────────────────────────────────────

  def start_link(opts) do
    instance = Keyword.fetch!(opts, :instance)
    GenServer.start_link(__MODULE__, opts, name: Hook.via(instance, :dispatch))
  end
  ...
  def tick(instance) do
    GenServer.call(Hook.via(instance, :dispatch), :tick)
  end
